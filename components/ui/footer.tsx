...
import { formatWhatsAppLink } from "@/app/lib/utils";
import { Dictionary, SiteSettings } from "@/types/definitions";
  ...
  return (
    <footer className="bg-background text-foreground border-t border-border">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div
          className={`grid gap-8 py-8 sm:grid-cols-12 md:py-12 ${border ? "border-t border-border" : ""}`}
        >
          {/* 1st block: Branding */}
          <div className="space-y-4 sm:col-span-12 lg:col-span-4 mb-4 lg:mb-0">
            ...
            <div className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} {businessName}. {dict.copyright}
            </div>
          </div>
          ...
          {/* 3rd block: Dynamic Partners from DB */}
          <FooterSection
          ...
          <div className="space-y-4 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="flex gap-4">
              <li>
                <Link
                  className="text-primary hover:scale-110 block"
                  href={whatsappUrl}
                  target="_blank"
                >
                  <WhatsappIcon />
      ...
      {/* Big text Background Decor */}
      <div
        className="pointer-events-none relative -mt-20 mb-[-2rem] h-60 w-full overflow-hidden select-none"
        aria-hidden="true"
      >
        <div className="absolute left-1/2 -translate-x-1/2 text-center text-[100px] sm:text-[150px] md:text-[250px] lg:text-[320px] font-bold leading-none">
          {/* 
            We use a single span with bg-clip-text. 
            This is identical to the 'before'/'after' look but easier to debug.
          */}
          <span className="bg-linear-to-b from-border/80 to-muted/20 bg-clip-text text-transparent opacity-70">
            {config.theme.shortName}
          </span>
        </div>
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-40 w-40 md:h-56 md:w-56 rounded-full border-[20px] border-primary/30 blur-[60px] md:blur-[80px]"></div>
        </div>
      </div>
    </footer>
  );
...
// --------------------------------------------------------------------------------
function FooterSection({ title, children, className }: any) {
