...
function NavigationMenuContent({
  ...
  "bg-white/90 backdrop-blur-md text-gray-800 rounded-xl shadow-lg border border-gray-100",
  ...
  "group-data-[viewport=false]/navigation-menu:duration-200", className)}
